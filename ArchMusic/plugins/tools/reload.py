...
from ZenMusic.utils.database import get_authuser_names, get_cmode
from ZenMusic.utils.decorators import (ActualAdminCB, AdminActual,
                                         language)
from ZenMusic.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await ZenMusic.stop_stream(message.chat.id)
    except:
        pass
